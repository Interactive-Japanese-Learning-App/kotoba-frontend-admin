      ...
      "
        >
            ...
            <div>
                ...
                <div className="px-6 pt-6 pb-8">
                    <div className="flex items-center gap-3">
                        <img src={logo} alt="Kotoba Logo" className="w-[42px]" />

                        <div>
                            <h1 className="text-[24px] font-extrabold text-[#123b5d] tracking-wide">
                                KOTOBA
                            </h1>
            ...
            <div className="p-4 flex flex-col gap-3">
                {/* PROFILE */}
                <div className="bg-[#f8fafc] rounded-2xl p-3 flex items-center gap-3 border border-[#eeeeee]">
                    <img
